...
# introduced in 2022.3
try: from speech.speech import _getTextInfoSpeech_updateCache
except: pass
try: from speech.speech import _getTextInfoSpeech_considerSpelling
except: pass
try: from speech.speech import _isControlEndFieldCommand
except: pass
...
def monkeyPatched_2021_3_getTextInfoSpeech(  # noqa: C901
		info: textInfos.TextInfo,
		useCache: Union[bool, SpeakTextInfoState] = True,
		formatConfig: Dict[str, bool] = None,
		unit: Optional[str] = None,
...
def monkeyPatched_2022_3_getTextInfoSpeech(  # noqa: C901
		info: textInfos.TextInfo,
		useCache: Union[bool, SpeakTextInfoState] = True,
		formatConfig: Dict[str, bool] = None,
		unit: Optional[str] = None,
...
def monkeyPatched_2023_1_getTextInfoSpeech(  # noqa: C901
		info: textInfos.TextInfo,
		useCache: Union[bool, SpeakTextInfoState] = True,
		formatConfig: Dict[str, bool] = None,
		unit: Optional[str] = None,
...
if nvda_version >= (2023, 1, 0):
	...
	monkeyPatchedGetTextInfoSpeech = monkeyPatched_2022_3_getTextInfoSpeech
elif nvda_version >= (2021, 3, 0):
	monkeyPatchedGetTextInfoSpeech = monkeyPatched_2021_3_getTextInfoSpeech
else:
